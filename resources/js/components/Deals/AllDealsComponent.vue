    ...
    <tr :class="this.$parent.colorTr(deal.Stage)">
        ...
        <td>
            <a href="#" @click.prevent="changeEditDealId(deal.id, deal.Deal_Name, deal.Stage, deal.Account_Name.id)"
                class="btn btn-success mx-3"><i class="bi bi-pencil-fill"></i></a>
            <a href="#" @click.prevent="this.$parent.deleteDeal(deal.id)" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></a>
        </td>
    </tr>
</template>
